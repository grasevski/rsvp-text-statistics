...
select gender, agegroup, %2$s feature, count(*) pool from personAge
join %1$s u on u.userid=personAge.userid
...
from kiss
join personAge p1 on p1.userid=initiatinguserid
join personAge p2 on p2.userid=targetuserid
